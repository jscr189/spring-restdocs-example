...
@AutoConfigureRestDocs(uriScheme = "https",uriHost = "com.sjanagama",uriPort = 80)
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        pathParameters(
                            parameterWithName("beerId").description("UUID of desired beerId to get")
                        ),
                        requestParameters(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("createdDate").description("Create Date"),
                                ...
                                fieldWithPath("quantityOnHand").description("Beer Qty")
